...
class AttachmentService:
    ...
    def upload_attachment(
        self, file, document_id, description="", uploaded_by="Sistema"
    ):
        ...
        try:
            ...
            print(f"Error ao fazer upload: {e}")
            return None
    ...
    def get_document_attachments(self, document_id):
        ...
        try:
            ...
            print(f"Error ao buscar anexos: {e}")
            return []
    ...
    def get_attachment(self, attachment_id):
        ...
        try:
            ...
            print(f"Error ao buscar anexo: {e}")
            return None
    ...
    def delete_attachment(self, attachment_id):
        ...
        try:
            ...
            print(f"Error ao deletar anexo: {e}")
            return False
    ...
    def _load_attachments(self):
        ...
        try:
            ...
            print(f"Error ao carregar anexos: {e}")
            return []
    ...
    def _save_attachment(self, attachment):
        ...
        try:
            ...
            print(f"Error ao salvar anexo: {e}")
    ...
    def _save_attachments(self, attachments):
        ...
        try:
            ...
            print(f"Error ao salvar anexos: {e}")
    ...
    def update_attachment_description(self, attachment_id, description):
        ...
        try:
            ...
            print(f"Error ao atualizar descrição: {e}")
            return None
    ...
    def get_attachment_stats(self, document_id):
        ...
        try:
            ...
            print(f"Error ao buscar estatísticas: {e}")
            return {
                "total_attachments": 0,
                "total_size_bytes": 0,
                "total_size_mb": 0,
