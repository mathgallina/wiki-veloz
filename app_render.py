...
@app.route("/documents/api/documents", methods=["GET"])
@login_required
def get_documents():
    ...
    try:
        ...
        documents = [
            {
                "id": "1d1d5d37-0ebf-415c-8902-f012e0f6234f",
                "title": "Teste",
                "description": "",
                "category_id": "meeting-minutes",
                "type": "ata",
                "status": "ativo",
                "priority": "media",
                "content": "Teste com mais de 10 caracteres",
                "author": "Sistema",
                "version": 1,
                "created_at": "2025-07-23T14:19:43.454753",
                "updated_at": "2025-07-23T14:19:43.454763"
            }
        ]
...
@app.route("/documents/api/documents/categories", methods=["GET"])
@login_required
def get_categories():
        ...
        categories = [
            {
                ...
                "description": "Documentos de reuniões",
                "color": "#3B82F6",
                "icon": "fas fa-file-alt",
                "created_at": "2025-07-23T00:00:00",
                "updated_at": "2025-07-23T00:00:00"
            }
        ]
