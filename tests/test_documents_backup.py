...
class TestDocumentModels:
    ...
    def test_document_creation(self):
        ...
        doc = Document(id="doc-1", title="Doc 1", category_id="cat-1", type="ata", status="ativo", description="Test description", priority="media", content="Test content", author="Test Author", version=1, created_at="2024-01-01T00:00:00", updated_at="2024-01-01T00:00:00")
            id="test-id",
            title="Test Document",
...
class TestDocumentRepository:
    ...
    def test_search_documents(self):
        ...
        doc1 = Document(id="doc-1", title="Doc 1", category_id="cat-1", type="ata", status="ativo", description="Test description", priority="media", content="Test content", author="Test Author", version=1, created_at="2024-01-01T00:00:00", updated_at="2024-01-01T00:00:00")
            id="test-1",
        ...
        doc2 = Document(id="doc-1", title="Doc 1", category_id="cat-1", type="ata", status="ativo", description="Test description", priority="media", content="Test content", author="Test Author", version=1, created_at="2024-01-01T00:00:00", updated_at="2024-01-01T00:00:00")
            id="test-2",
...
class TestDocumentService:
    ...
    def test_get_dashboard_stats(self):
        ...
        mock_docs = [
            Document(id="doc-1", title="Doc 1", category_id="cat-1", type="ata", status="ativo", description="Test description", priority="media", content="Test content", author="Test Author", version=1, created_at="2024-01-01T00:00:00", updated_at="2024-01-01T00:00:00")
                id="doc-1",
                title="Doc 1",
                category_id="cat-1",
                type="ata",
...
class TestDocumentAPI:
    ...
    def test_create_document_api(self):
        ...
        with patch(
            ...
            mock_create.return_value = Document(id="doc-1", title="Doc 1", category_id="cat-1", type="ata", status="ativo", description="Test description", priority="media", content="Test content", author="Test Author", version=1, created_at="2024-01-01T00:00:00", updated_at="2024-01-01T00:00:00")
                id="doc-1",
                title="Test Document",
                description="Test description",
                category_id="cat-1",
